...
*/
  ...
  public:
    T &operator[](E e) { return std::array<T, N>::operator[]((std::size_t)e); }

    const T &operator[](E e) const { return std::array<T, N>::operator[]((std::size_t)e); }
  };
  ...
  private:
    ...
    uint8_t reg_addresses[23] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47,
                                 0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4f};

    enum class Reg : uint8_t {
      INA = 0x00, INB = 0x01, OUTA = 0x02, OUTB = 0x03, INVERTA = 0x04, INVERTB = 0x05,
      CONFA = 0x06, CONFB = 0x07, STRENGHTAL = 0x08, STRENGTHAH = 0x09, STRENGTHBL = 0x0A,
      STRENGTHBH = 0x0B, INLATCHA = 0x0C, INLATCHB = 0x0D, PULLENA = 0x0E, PULLENB = 0x0F,
      PULLA = 0x10, PULLB = 0x11, IMASKA = 0x12, IMASKB = 0x13, ISTATA = 0x14, ISTATB = 0x15,
      OUTCONF = 0x16
    };
  ...
  public:
    ...
    enum class Pin : uint8_t {
      IOPIN_0, IOPIN_1, IOPIN_2, IOPIN_3, IOPIN_4, IOPIN_5, IOPIN_6, IOPIN_7, IOPIN_8, IOPIN_9,
          IOPIN_10, IOPIN_11, IOPIN_12, IOPIN_13, IOPIN_14, IOPIN_15
    };
