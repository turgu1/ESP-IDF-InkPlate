...
void EInk::turn_off() {
  ...
  #if !((INKPLATE_6 && DMA_ENABLE) || INKPLATE_5_V2 || (INKPLATE_6_V2 && DMA_ENABLE) ||              \
  INKPLATE_6FLICK)
    GPIO.out &= ~(DATA | LE | CL);
  #else
    le_clear();
...
// Do not disable WAKEUP if older Inkplate6Plus is used.
  #if !INKPLATE_6PLUS
    wakeup_clear();
    #if !(INKPLATE_6PLUS_V2 || INKPLATE_5_V2 || INKPLATE_6_V2 || INKPLATE_6FLICK)
...
bool EInk::turn_on() {
  ...
  #if !((INKPLATE_6 && DMA_ENABLE) || (INKPLATE_6_V2 && DMA_ENABLE) || INKPLATE_6FLICK)
    cl_clear();
  #endif
...
void EInk::pins_z_state() {
  ...
  #if (INKPLATE_6 && DMA_ENABLE) || INKPLATE_5_V2 || (INKPLATE_6_V2 && DMA_ENABLE) || INKPLATE_6FLICK
